...
const NewTask = ({data}) => {
  return (
    <div>
      <div className='flex-shrink-0 h-[300px] w-[350px] bg-red-400 rounded-xl px-4 py-4'>
        <h1>New Task</h1><br />
            ...
            <div className='flex gap-5 mt-15 items-center justify-between'>
                <button className='bg-green-300 rounded-md px-2 py-1'>Accept</button>
                <button className='bg-red-500 rounded-md px-2 py-1'>Reject</button>
            </div>
        </div>
    </div>
  )
